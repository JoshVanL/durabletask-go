...
func RuntimeStatus(s *protos.WorkflowRuntimeState) protos.WorkflowStatus {
	if s.StartEvent == nil {
		return protos.WorkflowStatus_WORKFLOW_STATUS_PENDING
	} else if s.CompletedEvent != nil {
		return s.CompletedEvent.GetWorkflowStatus()
	} else if s.Stalled != nil {
		return protos.WorkflowStatus_WORKFLOW_STATUS_STALLED
	} else if s.IsSuspended {
		return protos.WorkflowStatus_WORKFLOW_STATUS_SUSPENDED
	}

	return protos.WorkflowStatus_WORKFLOW_STATUS_RUNNING
}
