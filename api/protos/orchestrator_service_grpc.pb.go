...
const (
	...
	TaskHubSidecarService_RerunWorkflowAfterEvent_FullMethodName         = "/TaskHubSidecarService/RerunWorkflowAfterEvent"
...
type TaskHubSidecarServiceClient interface {
	...
	RerunWorkflowAfterEvent(ctx context.Context, in *RerunWorkflowAfterEventRequest, opts ...grpc.CallOption) (*RerunWorkflowAfterEventResponse, error)
...
func (c *taskHubSidecarServiceClient) RerunWorkflowAfterEvent(ctx context.Context, in *RerunWorkflowAfterEventRequest, opts ...grpc.CallOption) (*RerunWorkflowAfterEventResponse, error) {
	out := new(RerunWorkflowAfterEventResponse)
	err := c.cc.Invoke(ctx, TaskHubSidecarService_RerunWorkflowAfterEvent_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TaskHubSidecarServiceServer interface {
	...
	RerunWorkflowAfterEvent(context.Context, *RerunWorkflowAfterEventRequest) (*RerunWorkflowAfterEventResponse, error)
...
func (UnimplementedTaskHubSidecarServiceServer) RerunWorkflowAfterEvent(context.Context, *RerunWorkflowAfterEventRequest) (*RerunWorkflowAfterEventResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RerunWorkflowAfterEvent not implemented")
}
...
func _TaskHubSidecarService_RerunWorkflowAfterEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RerunWorkflowAfterEventRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TaskHubSidecarServiceServer).RerunWorkflowAfterEvent(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaskHubSidecarService_RerunWorkflowAfterEvent_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaskHubSidecarServiceServer).RerunWorkflowAfterEvent(ctx, req.(*RerunWorkflowAfterEventRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TaskHubSidecarService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RerunWorkflowAfterEvent",
			Handler:    _TaskHubSidecarService_RerunWorkflowAfterEvent_Handler,
		},
		{
